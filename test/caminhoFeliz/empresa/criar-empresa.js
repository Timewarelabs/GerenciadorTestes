    ...
    try {
        ...
        await allure.step("Acessando página de cadastro de empresa", async (ctx) => {
            try {
                ...
                await CapturaTela(driver, "Erro ao acessar a página");
                throw erro;
            }
        });
        ...
        await allure.step("Preenchendo os dados da empresa", async (ctx) => {
            try {
               ...
               await driver.actions().sendKeys(Key.TAB, cnpjAlvo).perform();
                ...
                await CapturaTela(driver, "Erro ao preencher os dados");
                throw erro;
            }
        });
            ...
            try {
                ...
                if (elementosErro.length > 0) {
                    ...
                    if (mensagemErro.includes("Houve um problema")) {
                        ...
                        await CapturaTela(driver, `Erro no cadastro - ${mensagemErro}`);
                ...
                await CapturaTela(driver, "Erro ao verificar sucesso do cadastro");
                throw erro;
            }
        });
