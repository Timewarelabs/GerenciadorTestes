...
async function falhaCriarCompromissoApenasHora(driver) {
    console.log("Iniciando teste: Compromisso - Apenas Hora");

    await allure.step("Executando cenário: Apenas Hora", async (ctx) => {
        ...
        assert.ok(estaDesabilitado, `Botão Salvar deveria estar desabilitado (Apenas Hora)`);
...
export { falhaCriarCompromissoApenasHora };