...
async function falhaCriarCompromissoTituloVazio(driver) {
    console.log("Iniciando teste: Compromisso - Título vazio");

    await allure.step("Executando cenário: Título vazio", async (ctx) => {
        ...
        // Título fica vazio intencionalmente
        ...
        assert.ok(estaDesabilitado, `Botão Salvar deveria estar desabilitado (Título vazio)`);
...
export { falhaCriarCompromissoTituloVazio };