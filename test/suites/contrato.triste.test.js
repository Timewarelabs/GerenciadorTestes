...
describe('Testes Caminho Triste Contrato', function() {
    ...
    it('Deve falhar ao criar contrato com campos obrigatórios vazios', async function() {
    ...
    it('Deve falhar ao criar contrato com número inválido (letras em campo numérico)', async function() {
        allure.parentSuite("CaminhoTriste");
        allure.suite("Contrato");
    ...
    it('Deve falhar ao criar contrato com data inválida', async function() {
        allure.parentSuite("CaminhoTriste");
        allure.suite("Contrato");
    ...
    it('Deve falhar ao atualizar contrato removendo campos obrigatórios', async function() {
        allure.parentSuite("CaminhoTriste");
        allure.suite("Contrato");
    ...
    it('Deve falhar ao atualizar contrato com número inválido', async function() {
        allure.parentSuite("CaminhoTriste");
        allure.suite("Contrato");
    ...
    it('Deve falhar ao atualizar contrato com data inválida', async function() {
        allure.parentSuite("CaminhoTriste");
        allure.suite("Contrato");
